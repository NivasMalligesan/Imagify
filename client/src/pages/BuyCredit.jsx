...
const BuyCredit = () => {
  ...
  return (
    ...
    className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <h1 className='text-center text-3xl font-medium mb-2 sm:mb-10  '>Choose The Plans</h1>

      <div className='flex flex-wrap justify-center gap-6 text-left '>
        {plans.map((item,index) => (
          <div key={index} className='
          bg-white drop-shadow-sm rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500'>
